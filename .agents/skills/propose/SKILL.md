...
- 출력: `.Codex/scratch/proposal-{YYYY-MM-DD-HHMMSS}.md` + stdout 1줄 요약
...
2. AGENTS.md "Output-to-File-First" 룰 인용
3. `.Codex/scratch/proposal-{ts}.md` 명명 규칙 인용
4. 비전 baseline 은 메모리(`~/.Codex/projects/-Users-sangwonlee-agent-dashboard/memory/project_agentville.md`) 의 Why/How 섹션을 *반드시* 인용해서 시작할 것
...
- proposal 파일은 `.gitignore` 처리된 `.Codex/scratch/` 안 → 휘발성, 채택된 항목만 사용자가 ROADMAP/메모리로 승격.
